    ...
    public function build() {
        ...
        for($y = $year - 2; $y <= $year + 1; $y++) {
            for($h = 1; $h <= 2; $h++) {
                ...
                $date = "<div class=\"calendar-controls\"><div class=\"year-text\">{$y}</div><div class=\"calendar-buttons\"><button class=\"calendar-prev-btn\" id=\"{$y}-{$h}-prev-btn\"><i class=\"prev\"></i></button><button class=\"calendar-next-btn\" id=\"{$y}-{$h}-next-btn\"><i class=\"next\"></i></button></div></div>";
